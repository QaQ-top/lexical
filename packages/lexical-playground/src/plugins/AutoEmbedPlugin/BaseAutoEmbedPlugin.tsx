...
export const INSERT_BASE_EMBED_COMMAND: LexicalCommand<EmbedConfig['type']> =
...
type BaseAutoEmbedPluginProps<TEmbedConfig extends EmbedConfig> = {
...
export function BaseAutoEmbedPlugin<TEmbedConfig extends EmbedConfig>({
  embedConfigs,
  onOpenEmbedModalForConfig,
  getMenuOptions,
  menuRenderFn,
  menuCommandPriority = COMMAND_PRIORITY_LOW,
}: BaseAutoEmbedPluginProps<TEmbedConfig>): JSX.Element | null {
