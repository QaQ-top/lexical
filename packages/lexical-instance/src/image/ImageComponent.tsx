...
function BrokenImage(): JSX.Element {
  return (
    <img
      src={
        'https://miaobi-lite.bj.bcebos.com/miaobi/5mao/b%275a2X56ym5Liy55So5LuA5LmI56ym5Y%2B36KGo56S6XzE3MzI1NTU1MDYuOTQyMzEwM18xNzMyNTU1NTA3LjE4OTcxOTQ%3D%27/1.png'
      }
      style={{
        height: 200,
        opacity: 0.2,
