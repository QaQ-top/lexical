...
import {$createInstanceCodeNode} from './index';

export const DEFAULT_CODE_LANGUAGE = 'javascript';

type SerializedInstanceCodeHighlightNode = Spread<
  {
...
/** @noInheritDoc */
export class InstanceCodeHighlightNode extends TextNode {
  /** @internal */
  ...
  static clone(node: InstanceCodeHighlightNode): InstanceCodeHighlightNode {
    return new InstanceCodeHighlightNode(
      node.__text,
  ...
  static importJSON(
    serializedNode: SerializedInstanceCodeHighlightNode,
  ): InstanceCodeHighlightNode {
    return $createInstanceCodeHighlightNode().updateFromJSON(serializedNode);
  }

  updateFromJSON(
    serializedNode: LexicalUpdateJSON<SerializedInstanceCodeHighlightNode>,
  ): this {
    return super
  ...
  exportJSON(): SerializedInstanceCodeHighlightNode {
    return {
      ...super.exportJSON(),
...
export function $createInstanceCodeHighlightNode(
  text: string = '',
  highlightType?: string | null | undefined,
): InstanceCodeHighlightNode {
  return $applyNodeReplacement(
    new InstanceCodeHighlightNode(text, highlightType),
  );
}

export function $isInstanceCodeHighlightNode(
  node: LexicalNode | InstanceCodeHighlightNode | null | undefined,
): node is InstanceCodeHighlightNode {
  return node instanceof InstanceCodeHighlightNode;
}

function $getLastMatchingCodeNode<D extends CaretDirection>(
  anchor: InstanceCodeHighlightNode | TabNode | LineBreakNode,
  direction: D,
): InstanceCodeHighlightNode | TabNode | LineBreakNode {
  let matchingNode: InstanceCodeHighlightNode | TabNode | LineBreakNode =
    anchor;
  for (
    ...
    caret &&
    ($isInstanceCodeHighlightNode(caret.origin) || $isTabNode(caret.origin));
